 ...
 */
app.put('/characters', function(req, res, next) {
...
/**
 * GET /characters/shame
 * Returns 100 lowest ranked characters.
 */
app.get('/characters/shame', function(req, res, next) {
  Character
    .find()
    .sort('-losses')
    .limit(100)
 ...
 */
app.get('/characters/top', function(req, res, next) {
 ...
 */
app.get('/characters/count', function(req, res, next) {
 ...
 */
app.get('/characters/search', function(req, res, next) {
